  ...
  <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75">
    <div class="bg-white rounded-lg shadow-xl overflow-hidden max-w-2xl w-full flex flex-col max-h-[90vh]">
      ...
      <div class="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
        ...
        <button class="text-gray-400 hover:text-gray-500 focus:outline-none" @click="onCancel">
      ...
      <div class="px-4 py-3 border-t border-gray-200 bg-gray-50 flex justify-between items-center">
        <div class="flex gap-2">
          <button type="button" class="p-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100" title="向左旋转" @click="rotate(-90)">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" />
            </svg>
          </button>
          <button type="button" class="p-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100" title="向右旋转" @click="rotate(90)">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 10h-10a8 8 0 00-8 8v2M21 10l-6 6m6-6l-6-6" />
            </svg>
          </button>
          <button type="button" class="p-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100" title="重置" @click="reset">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
