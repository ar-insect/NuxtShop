const enUS = {
  ...
  pages: {
    ...
    login: {
      ...
      helperPrefix: 'Enter your account details to sign in',
      ...
      submit: 'Sign in',
      twoFactorHint: 'A verification code has been sent to {phone}. Enter the 6-digit code to continue.',
      twoFactorCodePlaceholder: 'Enter 6-digit code',
      twoFactorSubmit: 'Verify and sign in',
      twoFactorSent: 'Verification code sent to {phone}. It will expire in 5 minutes.',
      twoFactorCodeRequired: 'Please enter the verification code',
    ...
    register: {
      ...
      captchaPhoneRequired: 'Please enter your phone number before completing the verification.',
  ...
  validation: {
    ...
    passwordWeak: 'Password must include both letters and numbers',
  ...
  error: {
    ...
    codes: {
      ...
      AUTH_REGISTER_PASSWORD_WEAK: 'Password must be at least 8 characters and include both letters and numbers.',
  ...
  profile: {
    ...
    security: {
      ...
      newPasswordSameError: 'New password must be different from the current password',
      confirmPasswordLabel: 'Confirm new password',
      confirmPasswordPlaceholder: 'Re-enter the new password',
      confirmPasswordError: 'The two passwords do not match',
      updatePasswordButton: 'Update password',
      updatePasswordSuccess: 'Password updated. Please sign in again with your new password.',
      ...
      loginHistoryEmptyDesc: 'No login records yet. Your logins will appear here next time.'
    }
  },
  ui: {
    clear: 'Clear',
