    ...
    <section>
      ...
      <div class="demo-item">
        ...
        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
          <button class="error-btn" @click="triggerVueError">触发 Vue 错误</button>
          <button class="error-btn" @click="triggerPromiseError">触发 Promise 错误</button>
          <button class="error-btn" @click="triggerManualError">手动记录错误</button>
          <button class="error-btn" @click="triggerThrowError">直接抛出异常</button>
        </div>
      </div>
    </section>
